...
(function () {
    ...
    try {
        ...
        const validTheme = ['default', 'light', 'classic'].includes(savedTheme) ? savedTheme : 'classic';
        ...
        const bg = themeBackgrounds[validTheme] || themeBackgrounds.classic;
        ...
        if (bg === 'transparent') {
            ...
            style.textContent =
                'html,body{background:transparent!important;min-height:100vh!important;margin:0!important;padding:0!important;position:relative!important;}html::before,body::before{content:"";position:fixed;top:0;left:0;width:100%;height:100%;background:' +
                bg +
            ...
            style.textContent =
                ...
                bg +
                '!important;color:#ffffff!important;min-height:100vh!important;margin:0!important;padding:0!important;}';
        }
